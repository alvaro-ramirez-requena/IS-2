...
export default function TechnicianFieldWorkPage() {
    ...
    const handleSaveNotes =
        async () => {
            ...
            if (!online) {
                ...
                setSuccessMessage(
                    "Sin conexión: las notas se guardaron localmente."
                );
    ...
    const handleSyncLocalNotes =
        async () => {
            ...
            if (!online) {
                setError(
                    "Necesitas conexión para sincronizar las notas."
                );
            ...
            try {
                ...
                setError(
                    error.message ||
                    "No se pudieron sincronizar las notas."
                );
    ...
    const handleClose =
        async () => {
            ...
            if (!canClose) {
                setError(
                    "Completa la llegada, las notas y las fotografías antes y después."
                );
            ...
            try {
                ...
                setSuccessMessage(
                    "Trabajo de campo finalizado. Continuando al cierre técnico."
                );
        ...
        return (
            ...
            ">
                ...
                ">
                    ...
                    ">
                        {error ||
                            "No se pudo recuperar la información solicitada."}
                    </p>
                    ...
                    ">
                        ...
                        ">
                            ...
                            <p className="
                                ...
                                sm:text-lg
                            ">
                                Registra tu llegada, las observaciones y las evidencias antes y después de la intervención.
                            </p>
                                ...
                                ">
                                    ...
                                    ">
                                        ...
                                        fieldWork
                                            ?.distanceMeters !==
                                            undefined
                                            ? `${fieldWork.distanceMeters.toFixed(
                                                0
                                            )} metros`
                                            : "No calculada"}
                                    </p>
                        ...
                        `}>
                            ...
                            {!canClose &&
                                ...
                                <p className="
                                    ...
                                    text-slate-500
                                ">
                                    Completa todos los requisitos indicados en el panel lateral para habilitar el cierre.
                                </p>
                            )}
