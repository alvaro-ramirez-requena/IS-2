          ...
          <div className="mt-14 flex gap-6">
            ...
            {work.status === "ACCEPTED" && (
              <button
                ...
                className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl p-5 text-xl font-semibold transition"
              >
                Marcar en traslado
              </button>
            )}

            {work.status === "ON_ROUTE" && (
              <button
                onClick={() => updateStatus("IN_PROGRESS")}
                className="flex-1 bg-yellow-600 hover:bg-yellow-700 text-white rounded-2xl p-5 text-xl font-semibold transition"
              >
                Iniciar atención
              </button>
            )}
