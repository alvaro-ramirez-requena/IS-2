        ...
        const fetchReports =
            async () => {
                try {
                    ...
                    const response =
                        await fetch(
                            `${API_BASE}/reports/map/locations`
                        );
                    ...
                    console.error(
                        "Error cargando reportes del mapa:",
                        error
                    );
        ...
        (results, status) => {
            ...
            const nearbyReports =
                reports.filter((report) => {
                    ...
                    const problemType =
                        report.problemType?.toLowerCase() || "";
            ...
            ">
                ...
                ">
                    <div className="
                        ...
                        p-6
                    ">
                        No se pudo cargar Google Maps. Revisa que tengas
                        activada la Maps JavaScript API y que tu API key sea válida.
                    </div>
                </main>
            </div>
        );
            ...
            ">
                ...
                ">
                    ...
                    <p className="
                        ...
                        mt-3
                    ">
                        Visualiza reportes registrados con ubicación para
                        identificar incidencias cercanas en tu zona.
                    </p>
                                        ...
                                        ">
                                            ...
                                            ">
                                                {selectedReport.address ||
                                                    "Ubicación registrada por coordenadas."}
                                            </p>
