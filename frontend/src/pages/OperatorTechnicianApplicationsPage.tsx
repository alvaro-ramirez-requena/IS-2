...
export default function OperatorTechnicianApplicationsPage() {
    ...
    const [applications, setApplications] =
        useState<TechnicianApplication[]>([]);
    ...
    const handleApprove =
        async (applicationId: string) => {
            try {
                ...
                setError(
                    error.message || "No se pudo aprobar la postulación."
                );
            }
        };
    ...
    const handleReject =
        async (applicationId: string) => {
            try {
                ...
                setError(
                    error.message || "No se pudo rechazar la postulación."
                );
            }
        };
            ...
            ">
                ...
                ">
                    ...
                    <p className="
                        ...
                        mt-3
                    ">
                        Revisa las solicitudes pendientes y decide si el
                        postulante será incorporado al equipo técnico.
                    </p>
                </div>
                                    ...
                                    <div>
                                        ...
                                        ">
                                            ...
                                            <p>
                                                ...
                                                {application.phone || "No indicado"}
                                            </p>

                                            <p>
                                                <strong>DNI:</strong>{" "}
                                                {application.dni || "No indicado"}
                                            </p>
