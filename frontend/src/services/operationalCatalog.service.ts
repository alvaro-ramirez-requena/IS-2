...
export const OperationalCatalogService = {
  async getCategories() {
    ...
    return (await parseResponse(response, "No se pudieron cargar las categorías.")) as Category[];
  },
  ...
  async createCategory(data: { name: string; description?: string }) {
    ...
    return (await parseResponse(response, "No se pudo crear la categoría.")) as Category;
  },
  ...
  async updateCategory(
    ...
    return (await parseResponse(response, "No se pudo actualizar la categoría.")) as Category;
  },
  ...
  async createProblemType(data: { name: string; description?: string; categoryId: string }) {
    ...
    return (await parseResponse(response, "No se pudo crear el tipo de problema.")) as ProblemType;
  },
  ...
  async updateProblemType(
    ...
    const response = await fetch(`${API_BASE}/problem-types/${id}`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  async toggleProblemType(id: string, active: boolean) {
    const response = await fetch(
  ...
  async getClosureReasons() {
    const response = await fetch(`${API_BASE}/closure-reasons`);
  ...
  async createClosureReason(data: { name: string; description?: string }) {
    const response = await fetch(`${API_BASE}/closure-reasons`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  async updateClosureReason(
    ...
    const response = await fetch(`${API_BASE}/closure-reasons/${id}`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  async toggleClosureReason(id: string, active: boolean) {
    const response = await fetch(
  ...
  async getSlaConfigurations() {
    ...
    return (await parseResponse(response, "No se pudieron cargar los SLA.")) as SlaConfiguration[];
  },

  async updateSla(priority: "BAJO" | "MEDIO" | "ALTO", responseHours: number) {
    const response = await fetch(`${API_BASE}/sla-configurations/${priority}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    return (await parseResponse(response, "No se pudo actualizar el SLA.")) as SlaConfiguration;
  },
  ...
  async getActiveProblemTypes() {
    const response = await fetch(`${API_BASE}/problem-types/active`);
  ...
  async getActiveClosureReasons() {
    const response = await fetch(`${API_BASE}/closure-reasons/active`);
