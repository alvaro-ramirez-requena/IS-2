...
export const FieldWorkService = {
    ...
    async start(
        ...
        const response =
            await fetch(
                `${API_BASE}/fieldwork/${reportId}/start`,
                {
                    method: "POST",
                    headers: {
    ...
    async registerArrival(data: {
        ...
        const response =
            await fetch(
                `${API_BASE}/fieldwork/${data.reportId}/arrive`,
                {
                    method: "PATCH",
                    headers: {
                        "Content-Type": "application/json",
    ...
    async saveNotes(
        ...
        const response =
            await fetch(
                `${API_BASE}/fieldwork/${reportId}/notes`,
                {
                    method: "PATCH",
                    headers: {
                        "Content-Type": "application/json",
    ...
    async addEvidence(data: {
        ...
        const response =
            await fetch(
                `${API_BASE}/fieldwork/${data.reportId}/evidence`,
                {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
    ...
    async deleteEvidence(
        ...
        const response =
            await fetch(
                `${API_BASE}/fieldwork/evidence/${evidenceId}`,
                {
                    method: "DELETE",
                }
            );
    ...
    async close(
        ...
        const response =
            await fetch(
                `${API_BASE}/fieldwork/${reportId}/close`,
                {
                    method: "PATCH",
                }
            );
