...
- Seguridad ciudadana: Robo o hurto, Presencia de pandillas, Violencia doméstica, Consumo de drogas en vía pública, Acoso callejero, Incidente de violencia
- Ambiente y limpieza: Acumulación de basura, Quema de residuos, Contaminación de agua, Ruido excesivo, Presencia de plagas, Microbasural
- Infraestructura: Pista en mal estado, Vereda dañada, Alumbrado público defectuoso, Semáforo dañado, Fuga de agua, Colapso de desagüe
- Movilidad y transporte: Vehículo abandonado, Señalización vial deteriorada, Paradero informal, Venta ambulante no autorizada, Exceso de velocidad
