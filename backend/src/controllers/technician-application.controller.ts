...
export class TechnicianApplicationController {
  async create(req: Request, res: Response) {
    try {
      const application = await technicianApplicationService.createApplication({
  ...
  async verifyEmail(req: Request, res: Response) {
    try {
      ...
      const application = await technicianApplicationService.verifyEmail(token);
  ...
  async getPending(req: Request, res: Response) {
    try {
      ...
      const applications =
        await technicianApplicationService.getPendingApplicationsForOperator(operatorId);
  ...
  async getAll(req: Request, res: Response) {
    try {
      const applications = await technicianApplicationService.getAllApplications();
  ...
  async approve(req: Request, res: Response) {
    try {
      ...
      const reviewedById = req.body.reviewedById;
  ...
  async reject(req: Request, res: Response) {
    try {
      ...
      const application = await technicianApplicationService.rejectApplication(
        applicationId,
        reviewedById
      );
